...
new class extends Component {
    ...
    public array $shelfOrder = ['Pro 13"', 'Pro 15"', 'Pro 16"', 'Air 13"', 'Air 15"', 'Air 16"', 'iPhone', 'iPad', 'iPad Pro', 'Zubehör', 'Sonstiges'];
    ...
    */
    public function getGroupedAppleItems(): Collection
    {
        return AppleItem::with('inventoryItem')
            ...
            ->map(function ($items) {
                return $items->sortBy([['release_year', 'asc'], ['model', 'asc'], ['cpu', 'desc'], ['ram', 'asc'], ['ssd', 'asc']]);
            })
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                @forelse($appleItems as $shelf => $shelfItems)
                    ...
                    @foreach ($shelfItems as $appleItem)
                        ...
                        <tr class="hover:bg-gray-50" wire:click="edit('{{ $appleItem->id }}')">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex justify-end gap-2">
                                    <button type="button" wire:click.stop="edit('{{ $appleItem->id }}')"
                                        class="rounded-lg px-3 py-1.5 text-sm hover:bg-gray-100">
                                        Bearbeiten
                                    </button>
